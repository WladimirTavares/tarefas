...
char* dirTarefas = "/usr/lib/cgi-bin/tarefas2dev";		// ok!

char* dirHtml = "/usr/lib/cgi-bin/tarefas2dev/html";
...
char* urlTarefas = "http://tarefas.dc.ufc.br/dev";

//char* urlTarefasDwl = "http://200.19.179.27:8091/tarefasdevdwl";
char* urlTarefasDwl = "http://tarefas.dc.ufc.br/tarefasdevdwl";

char* urlTarefasDwlTarefas = "http://tarefas.dc.ufc.br/tarefasdevdwl/tarefas";

//char* urlTarefasDwldr = "http://200.19.179.27:8091/tarefas2dev/dwldr/dwldr.cgi";




char* caminhoTarefasBD = "/usr/lib/cgi-bin/tarefas2dev/dados/tarefas.bd";



char* dirDados = "/usr/lib/cgi-bin/tarefas2dev/dados";

char* dirDadosTarefas = "/usr/lib/cgi-bin/tarefas2dev/dados/tarefas";

char* dirDadosTrabalhos = "/usr/lib/cgi-bin/tarefas2dev/dados/trabalhos";



char* dirDownloads = "/usr/lib/cgi-bin/tarefas2dev/downloads";

char* dirDownloadsTarefas = "/usr/lib/cgi-bin/tarefas2dev/downloads/tarefas";

char* dirDownloadsTrabalhos = "/usr/lib/cgi-bin/tarefas2dev/downloads/trabalhos";
