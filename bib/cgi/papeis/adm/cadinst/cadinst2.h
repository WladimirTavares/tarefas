...
int visualizarInst(Usuario* usu, Sessao* sessao, FormularioHTML* form, char* msg) {
	...
	if (cfIdInst) {
		...
		if (utf8Val(idInst, CHARDIG, NULL)) {
			...
			paginaCadinst(usu, sessao, form, "<font color=\"#ff0000\">Caractere inválido no identificador de instituição.</font>");
			return 1;
		}
		...
		paginaCadinst(usu, sessao, form, "<font color=\"#ff0000\">Erro ao tentar receber instituição do formulário.</font>");
		return 3;
	}
...
int atualizarInst2(Usuario* usu, Sessao* sessao, FormularioHTML* form) {
	...
	if (utf8Val(sigla, CHARNOME, NULL)) {
		...
		paginaCadinst(usu, sessao, form, "<font color=\"#ff0000\">Caractere inválido na sigla.</font>");
		return 1;
	}
	...
	if (utf8Val(nome, CHARNOME, NULL)) {
		...
		paginaCadinst(usu, sessao, form, "<font color=\"#ff0000\">Caractere inválido no nome.</font>");
		return 1;
	}
	...
	if (utf8Val(obs, CARVALSML, NULL)) {
		...
		paginaCadinst(usu, sessao, form, "<font color=\"#ff0000\">Caractere inválido na observação.</font>");
		return 1;
	}
